...
class EventServer : public WiFiServer {
  public:
    ...
    bool subscribe(const EventCallback &callback, const String &subscriptionURL, String *SID = nullptr, unsigned int timeoutSeconds = 3600,
                   double renewalThreshold = 0.9);
